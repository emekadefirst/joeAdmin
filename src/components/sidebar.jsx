        ...
        <div className="w-64 md:w-72 h-full bg-white shadow-xl flex flex-col">
          ...
          <div className="p-2">
            <nav className="space-y-1">
              ...
              {/* Daily Content */}
              <Link to="/program/daily" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-blue-900 hover:bg-blue-50 transition-colors">
              ...
              {/* Programs */}
              <Link to="/program" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-blue-900 hover:bg-blue-50 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-blue-900/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
